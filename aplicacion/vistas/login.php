...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('assets/media/auth/bg-valcas.png'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg-valcas.png'); }</style>
			<!--end::Page bg image-->
			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						<!--begin::Logo-->
						<a href="/" class="mb-7">
							<img src="assets/media/logos/logo-lg.svg" width="600px" class="d-none d-xxl-block"/>
							<img src="assets/media/logos/logo-lg.svg" width="500px" class="d-none d-xxl-none d-xl-block"/>
							<img src="assets/media/logos/logo-lg.svg" width="400px" class="d-none d-xxl-none d-xl-none d-lg-block"/>
							<img src="assets/media/logos/logo-lg.svg" width="300px" class="d-lg-none"/>
						</a>
						<!--end::Logo-->
					</div>
					<!--begin::Aside-->
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
					<!--begin::Card-->
					<div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-600px p-20">
						<!--begin::Wrapper-->
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/" action="#">
								<!--begin::Heading-->
